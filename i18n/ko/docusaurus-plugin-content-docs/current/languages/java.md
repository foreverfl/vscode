...
> **참고**: Java 개발을 시작하는 데 도움이 되도록 [Java 일반 프로필 템플릿](/docs/editor/profiles.md#java-general-profile-template)을 사용하여 유용한 확장을 설치할 수 있습니다. 프로필에 대해 더 알아보고, 프로필이 다양한 프로그래밍 언어와 워크플로우에 맞게 편집기를 빠르게 재구성하는 방법에 대해서는 [VS Code의 프로필](/docs/editor/profiles.md)에서 확인하세요.
