...
1. Switch to the **Run and Debug** view (`Ctrl+Shift+D`), select the appropriate configuration from the debugger dropdown list, and start the debugger.
...
1. Local computer: switch to the **Run and Debug** view (`Ctrl+Shift+D`) in VS Code, select the **Python Debugger: Attach** configuration
