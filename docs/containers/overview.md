...
You can get [IntelliSense](/docs/editor/intellisense.md) by clicking `Ctrl+Space` when editing your `Dockerfile` and `docker-compose.yml` files, with completions and syntax help for common commands.
