...
Last iteration, we added a `$\{focusedView\}
` variable to `window.title`. We now also indicate when a `Text Editor` is focused.
...
- [@hsfzxjy (hsfzxjy)](https://github.com/hsfzxjy): Fix faster \_\_vsc_escape_value [PR #194459](https://github.com/microsoft/vscode/pull/194459)
