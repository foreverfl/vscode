...
_Dragging the Watch view from the Run Side Bar to be next to the Debug Console in Panel_

![Custom History Group](images/1_46/custom-view-group.gif)

_Creating a custom history group in the Side Bar and Panel with Timeline and GitLens_
...
_Theme: [Topaz (Dim)](https://marketplace.visualstudio.com/items?itemName=Tyriar.theme-topaz)_
...
_Theme: [GitHub Dark Theme](https://marketplace.visualstudio.com/items?itemName=GitHub.github-vscode-theme)_
