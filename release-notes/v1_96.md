...
- `$\{shellType\}
` - The detected type of shell that is being used in the terminal. This is similar the default value, but it will not change to `git` for example when running a git command.
- `$\{shellCommand\}
