...
- [@TCPsoftware (tcpsoft)](https://github.com/TCPsoftware): Make "args": "$\{command:pickArgs\}
  " as default debug configuration [PR #548](https://github.com/microsoft/vscode-python-debugger/pull/548)
