...
1. To run your app, select **Run > Run without Debugging** in the upper menu, or use the `Ctrl+F5` keyboard shortcut. To learn more about debugging your C# project, read the [debugging documentation](/docs/csharp/debugging.md).
